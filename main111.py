...
"background-color: rgb(194, 194, 194);")
        ...
        self.pushButton_solve.setGeometry(QtCore.QRect(260, 560, 141, 61))
        self.pushButton_solve.setStyleSheet("font: 16pt \"Arial\";\nbackground-color: rgb(194, 194, 194);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        # 设置烦躁解决方法按钮的文本
        self.pushButton_solve.setText(_translate("MainWindow", "烦躁解决方法"))
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.setupUi(self)
        # 连接烦躁解决方法按钮的点击事件
        self.pushButton_solve.clicked.connect(self.show_solve)

    def show_solve(self):
        # 弹出烦躁解决方法的消息框
        QMessageBox.about(self, "烦躁解决方法", "尝试以下方法来缓解烦躁情绪：\n1. 深呼吸\n2. 散步\n3. 听音乐\n4. 与人交流")
